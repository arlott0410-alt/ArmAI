...
import type {
  ...
  PAYMENT_SWITCH_REQUESTED_BY,
} from './constants.js'

export type OrderStatus = (typeof ORDER_STATUS)[keyof typeof ORDER_STATUS]
export type MatchingResultStatus =
  (typeof MATCHING_RESULT_STATUS)[keyof typeof MATCHING_RESULT_STATUS]
...
export type PaymentSwitchRequestedBy =
  (typeof PAYMENT_SWITCH_REQUESTED_BY)[keyof typeof PAYMENT_SWITCH_REQUESTED_BY]
