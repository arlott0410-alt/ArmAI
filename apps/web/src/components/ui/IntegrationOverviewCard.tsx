  ...
  return (
    ...
    >
      ...
      {hasScoping && (
        ...
        >
          <span>
            <strong style={{ color: theme.success }}>{scoped}</strong> scoped
          </span>
          <span>
            <strong style={{ color: theme.warning }}>{ambiguous}</strong> ambiguous
          </span>
          <span>
            <strong style={{ color: theme.textMuted }}>{outOfScope}</strong> out of scope
          </span>
        </div>
      )}
    </div>
